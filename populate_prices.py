...
async def get_stocks():
    ...
    async with pool.acquire() as connection:
        ...
        symbol_urls = {}
        for stock in stocks:
            stock_api_url = f"https://api.polygon.io/v2/aggs/ticker/{stock['symbol']}/range/5/minute/2020-10-01/2021-11-03?apiKey={config.POLYGON_API_KEY}&limit=50000"
            symbol_urls[stock['id']] = stock_api_url
